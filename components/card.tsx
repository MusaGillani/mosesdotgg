...
const Card: React.FC<Props> = ({ icon, title, href }) => {
  return (
    <a
      href={href}
      className="flex h-32 w-32 scale-100 flex-col items-center justify-center rounded-xl bg-discord-purple p-5 shadow-lg transition delay-150 ease-in-out hover:-translate-y-3 hover:-rotate-6 hover:skew-y-3 hover:scale-105 dark:bg-teal-900 sm:h-52 sm:w-52 md:h-20 md:w-20"
    >
